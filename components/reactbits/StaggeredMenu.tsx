...
// TS port with two local additions:
//   - `logoNode` prop: lets the logo slot render arbitrary React nodes
//     (text labels, custom SVGs) instead of just an <img src=>.
//   - `onItemClick` prop: when present, intercepts anchor clicks so the
//     caller can handle navigation (smooth-scroll to section, routing,
//     etc.) and the menu auto-closes after.
