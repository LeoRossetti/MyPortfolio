    ...
    >
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <motion.form
          ...
          className="bg-bg-elevated/50 border-border-subtle space-y-5 rounded-2xl border p-6 backdrop-blur-md sm:p-8 lg:col-span-7"
        >
          {/* honeypot */}
          ...
          <div className="flex items-center justify-between gap-4">
            <p className="text-fg-dim text-[11px] tracking-wide">
...
function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <Label
        htmlFor={htmlFor}
        className="text-fg-muted font-mono text-[11px] tracking-wide uppercase"
      >
        {label}
      </Label>
      {children}
